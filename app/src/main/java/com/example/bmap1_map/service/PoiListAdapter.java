...
import com.example.bmap1_map.R;
...
public class PoiListAdapter extends BaseAdapter implements PoiChidrenAdapter.OnGetChildrenLocationListener {
    ...
    public PoiListAdapter(OnGetPoiSearchResultListener mcontext, List<PoiInfo> mPoilist) {
    ...
    public void setOnGetChildrenLocationListener(OnGetPoiSearchResultListener onGetChildrenLocationListener) {
        this.mOnGetChildrenLocationListener = (OnGetChildrenLocationListener) onGetChildrenLocationListener;
    }
